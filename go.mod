...
replace github.com/bytedance/sonic/loader => github.com/bytedance/sonic/loader v0.2.0

replace github.com/bytedance/sonic => github.com/bytedance/sonic v1.12.1
