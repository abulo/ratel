...
// 命令用于以 UNIX 时间戳(unix timestamp)格式设置 key 的过期时间
func (r *Client) ExpireNX(ctx context.Context, key string, tm time.Duration) (res *redis.BoolCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ExpireNX(ctx, r.k(key), tm)
	case ClientNormal:
		res = r.client.ExpireNX(ctx, r.k(key), tm)
	}
	return res
}
...
// 命令用于以 UNIX 时间戳(unix timestamp)格式设置 key 的过期时间
func (r *Client) ExpireXX(ctx context.Context, key string, tm time.Duration) (res *redis.BoolCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ExpireXX(ctx, r.k(key), tm)
	case ClientNormal:
		res = r.client.ExpireXX(ctx, r.k(key), tm)
	}
	return res
}
...
// 命令用于以 UNIX 时间戳(unix timestamp)格式设置 key 的过期时间
func (r *Client) ExpireGT(ctx context.Context, key string, tm time.Duration) (res *redis.BoolCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ExpireGT(ctx, r.k(key), tm)
	case ClientNormal:
		res = r.client.ExpireGT(ctx, r.k(key), tm)
	}
	return res
}
...
// 命令用于以 UNIX 时间戳(unix timestamp)格式设置 key 的过期时间
func (r *Client) ExpireLT(ctx context.Context, key string, tm time.Duration) (res *redis.BoolCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ExpireLT(ctx, r.k(key), tm)
	case ClientNormal:
		res = r.client.ExpireLT(ctx, r.k(key), tm)
	}
	return res
}
...
// SortRO -> Sort
func (r *Client) SortRO(ctx context.Context, key string, sort *redis.Sort) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.SortRO(ctx, r.k(key), sort)
	case ClientNormal:
		res = r.client.SortRO(ctx, r.k(key), sort)
	}
	return res
}
...
// GetEx
func (r *Client) GetEx(ctx context.Context, key string, ts time.Duration) (res *redis.StringCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.GetEx(ctx, r.k(key), ts)
	case ClientNormal:
		res = r.client.GetEx(ctx, r.k(key), ts)
	}
	return res
}

// GetEx
func (r *Client) GetDel(ctx context.Context, key string) (res *redis.StringCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.GetDel(ctx, r.k(key))
	case ClientNormal:
		res = r.client.GetDel(ctx, r.k(key))
	}
	return res
}
...
func (r *Client) SetArgs(ctx context.Context, key string, value interface{}, a redis.SetArgs) (res *redis.StatusCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.SetArgs(ctx, r.k(key), value, a)
	case ClientNormal:
		res = r.client.SetArgs(ctx, r.k(key), value, a)
	}
	return res
}
...
// Copy
func (r *Client) Copy(ctx context.Context, sourceKey string, destKey string, db int, replace bool) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.Copy(ctx, r.k(sourceKey), r.k(destKey), db, replace)
	case ClientNormal:
		res = r.client.Copy(ctx, r.k(sourceKey), r.k(destKey), db, replace)
	}
	return res
}
...
func (r *Client) ScanType(ctx context.Context, cursor uint64, match string, count int64, keyType string) (res *redis.ScanCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ScanType(ctx, cursor, r.k(match), count, keyType)
	case ClientNormal:
		res = r.client.ScanType(ctx, cursor, r.k(match), count, keyType)
	}
	return res
}
...
func (r *Client) HGetAll(ctx context.Context, key string) (res *redis.MapStringStringCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
...
func (r *Client) HRandField(ctx context.Context, key string, count int) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.HRandField(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.HRandField(ctx, r.k(key), count)
	}
	return res
}
func (r *Client) HRandFieldWithValues(ctx context.Context, key string, count int) (res *redis.KeyValueSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.HRandFieldWithValues(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.HRandFieldWithValues(ctx, r.k(key), count)
	}
	return res
}
...
func (r *Client) LPopCount(ctx context.Context, key string, count int) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.LPopCount(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.LPopCount(ctx, r.k(key), count)
	}
	return res
}

func (r *Client) LPos(ctx context.Context, key string, value string, args redis.LPosArgs) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.LPos(ctx, r.k(key), value, args)
	case ClientNormal:
		res = r.client.LPos(ctx, r.k(key), value, args)
	}
	return res
}
func (r *Client) LPosCount(ctx context.Context, key string, value string, count int64, args redis.LPosArgs) (res *redis.IntSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.LPosCount(ctx, r.k(key), value, count, args)
	case ClientNormal:
		res = r.client.LPosCount(ctx, r.k(key), value, count, args)
	}
	return res
}
...
func (r *Client) RPopCount(ctx context.Context, key string, count int) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.RPopCount(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.RPopCount(ctx, r.k(key), count)
	}
	return res
}
...
func (r *Client) LMove(ctx context.Context, source, destination, srcpos, destpos string) (res *redis.StringCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.LMove(ctx, r.k(source), r.k(destination), r.k(srcpos), r.k(destpos))
	case ClientNormal:
		res = r.client.LMove(ctx, r.k(source), r.k(destination), r.k(srcpos), r.k(destpos))
	}
	return res
}
func (r *Client) BLMove(ctx context.Context, source, destination, srcpos, destpos string, ts time.Duration) (res *redis.StringCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.BLMove(ctx, r.k(source), r.k(destination), r.k(srcpos), r.k(destpos), ts)
	case ClientNormal:
		res = r.client.BLMove(ctx, r.k(source), r.k(destination), r.k(srcpos), r.k(destpos), ts)
	}
	return res
}
...
// 如果 destination 集合已经存在，则将其覆盖。
// destination 可以是 key 本身。
func (r *Client) SInterCard(ctx context.Context, limit int64, keys ...string) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.SInterCard(ctx, limit, r.ks(keys...)...)
	case ClientNormal:
		res = r.client.SInterCard(ctx, limit, r.ks(keys...)...)
	}
	return res
}
...
func (r *Client) XAutoClaim(ctx context.Context, a *redis.XAutoClaimArgs) (res *redis.XAutoClaimCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XAutoClaim(ctx, a)
	case ClientNormal:
		res = r.client.XAutoClaim(ctx, a)
	}
	return res
}
func (r *Client) XAutoClaimJustID(ctx context.Context, a *redis.XAutoClaimArgs) (res *redis.XAutoClaimJustIDCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XAutoClaimJustID(ctx, a)
	case ClientNormal:
		res = r.client.XAutoClaimJustID(ctx, a)
	}
	return res
}

func (r *Client) XTrimMaxLen(ctx context.Context, key string, maxLen int64) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XTrimMaxLen(ctx, r.k(key), maxLen)
	case ClientNormal:
		res = r.client.XTrimMaxLen(ctx, r.k(key), maxLen)
	}
	return res
}
func (r *Client) XTrimMaxLenApprox(ctx context.Context, key string, maxLen, limit int64) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XTrimMaxLenApprox(ctx, r.k(key), maxLen, limit)
	case ClientNormal:
		res = r.client.XTrimMaxLenApprox(ctx, r.k(key), maxLen, limit)
	}
	return res
}
func (r *Client) XTrimMinID(ctx context.Context, key string, minID string) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XTrimMinID(ctx, r.k(key), minID)
	case ClientNormal:
		res = r.client.XTrimMinID(ctx, r.k(key), minID)
	}
	return res
}
func (r *Client) XTrimMinIDApprox(ctx context.Context, key string, minID string, limit int64) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XTrimMinIDApprox(ctx, r.k(key), minID, limit)
	case ClientNormal:
		res = r.client.XTrimMinIDApprox(ctx, r.k(key), minID, limit)
	}
	return res
}
...
func (r *Client) XInfoGroups(ctx context.Context, key string) (res *redis.XInfoGroupsCmd) {
	...
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XInfoGroups(ctx, r.k(key))
	case ClientNormal:
		res = r.client.XInfoGroups(ctx, r.k(key))
	}
	return res
}

func (r *Client) XInfoStream(ctx context.Context, key string) (res *redis.XInfoStreamCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XInfoStream(ctx, r.k(key))
	case ClientNormal:
		res = r.client.XInfoStream(ctx, r.k(key))
	}
	return res
}
func (r *Client) XInfoStreamFull(ctx context.Context, key string, count int) (res *redis.XInfoStreamFullCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XInfoStreamFull(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.XInfoStreamFull(ctx, r.k(key), count)
	}
	return res
}
func (r *Client) XInfoConsumers(ctx context.Context, key string, group string) (res *redis.XInfoConsumersCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.XInfoConsumers(ctx, r.k(key), group)
	case ClientNormal:
		res = r.client.XInfoConsumers(ctx, r.k(key), group)
	}
	return res
}
...
func (r *Client) ZAddArgs(ctx context.Context, key string, args redis.ZAddArgs) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZAddArgs(ctx, r.k(key), args)
	case ClientNormal:
		res = r.client.ZAddArgs(ctx, r.k(key), args)
	}
	return res
}
func (r *Client) ZAddArgsIncr(ctx context.Context, key string, args redis.ZAddArgs) (res *redis.FloatCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZAddArgsIncr(ctx, r.k(key), args)
	case ClientNormal:
		res = r.client.ZAddArgsIncr(ctx, r.k(key), args)
	}
	return res
}
...
func (r *Client) ZInter(ctx context.Context, store *redis.ZStore) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZInter(ctx, store)
	case ClientNormal:
		res = r.client.ZInter(ctx, store)
	}
	return res
}

func (r *Client) ZInterWithScores(ctx context.Context, store *redis.ZStore) (res *redis.ZSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZInterWithScores(ctx, store)
	case ClientNormal:
		res = r.client.ZInterWithScores(ctx, store)
	}
	return res
}
func (r *Client) ZInterCard(ctx context.Context, limit int64, keys ...string) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZInterCard(ctx, limit, r.ks(keys...)...)
	case ClientNormal:
		res = r.client.ZInterCard(ctx, limit, r.ks(keys...)...)
	}
	return res
}
...
func (r *Client) ZMScore(ctx context.Context, key string, members ...string) (res *redis.FloatSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZMScore(ctx, r.k(key), members...)
	case ClientNormal:
		res = r.client.ZMScore(ctx, r.k(key), members...)
	}
	return res
}
...
func (r *Client) ZRangeArgs(ctx context.Context, z redis.ZRangeArgs) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZRangeArgs(ctx, z)
	case ClientNormal:
		res = r.client.ZRangeArgs(ctx, z)
	}
	return res
}

func (r *Client) ZRangeArgsWithScores(ctx context.Context, z redis.ZRangeArgs) (res *redis.ZSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZRangeArgsWithScores(ctx, z)
	case ClientNormal:
		res = r.client.ZRangeArgsWithScores(ctx, z)
	}
	return res
}
func (r *Client) ZRangeStore(ctx context.Context, dst string, z redis.ZRangeArgs) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZRangeStore(ctx, dst, z)
	case ClientNormal:
		res = r.client.ZRangeStore(ctx, dst, z)
	}
	return res
}
...
func (r *Client) ZRandMember(ctx context.Context, key string, count int) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZRandMember(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.ZRandMember(ctx, r.k(key), count)
	}
	return res
}
func (r *Client) ZRandMemberWithScores(ctx context.Context, key string, count int) (res *redis.ZSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZRandMemberWithScores(ctx, r.k(key), count)
	case ClientNormal:
		res = r.client.ZRandMemberWithScores(ctx, r.k(key), count)
	}
	return res

}
func (r *Client) ZUnion(ctx context.Context, store redis.ZStore) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZUnion(ctx, store)
	case ClientNormal:
		res = r.client.ZUnion(ctx, store)
	}
	return res
}
func (r *Client) ZUnionWithScores(ctx context.Context, store redis.ZStore) (res *redis.ZSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZUnionWithScores(ctx, store)
	case ClientNormal:
		res = r.client.ZUnionWithScores(ctx, store)
	}
	return res
}
func (r *Client) ZDiff(ctx context.Context, keys ...string) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZDiff(ctx, r.ks(keys...)...)
	case ClientNormal:
		res = r.client.ZDiff(ctx, r.ks(keys...)...)
	}
	return res
}
func (r *Client) ZDiffWithScores(ctx context.Context, keys ...string) (res *redis.ZSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZDiffWithScores(ctx, r.ks(keys...)...)
	case ClientNormal:
		res = r.client.ZDiffWithScores(ctx, r.ks(keys...)...)
	}
	return res
}
func (r *Client) ZDiffStore(ctx context.Context, destination string, keys ...string) (res *redis.IntCmd) {
	...
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ZDiffStore(ctx, destination, r.ks(keys...)...)
	case ClientNormal:
		res = r.client.ZDiffStore(ctx, destination, r.ks(keys...)...)
	}
	return res
}
...
func (r *Client) ConfigGet(ctx context.Context, parameter string) (res *redis.MapStringStringCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
...
// ClientPause 停止处理来自客户端的命令一段时间
func (r *Client) ClientUnpause(ctx context.Context) (res *redis.BoolCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ClientUnpause(ctx)
	case ClientNormal:
		res = r.client.ClientUnpause(ctx)
	}
	return res
}
...
func (r *Client) ClientUnblock(ctx context.Context, id int64) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ClientUnblock(ctx, id)
	case ClientNormal:
		res = r.client.ClientUnblock(ctx, id)
	}
	return res
}

func (r *Client) ClientUnblockWithError(ctx context.Context, id int64) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.ClientUnblockWithError(ctx, id)
	case ClientNormal:
		res = r.client.ClientUnblockWithError(ctx, id)
	}
	return res
}
...
func (r *Client) SlowLogGet(ctx context.Context, num int64) (res *redis.SlowLogCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.SlowLogGet(ctx, num)
	case ClientNormal:
		res = r.client.SlowLogGet(ctx, num)
	}
	return res
}
...
// EvalRO 执行 Lua 脚本。
func (r *Client) EvalRO(ctx context.Context, script string, keys []string, args ...interface{}) (res *redis.Cmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.EvalRO(ctx, script, r.ks(keys...), args...)
	case ClientNormal:
		res = r.client.EvalRO(ctx, script, r.ks(keys...), args...)
	}
	return res
}

// EvalShaRO 执行 Lua 脚本。
func (r *Client) EvalShaRO(ctx context.Context, sha1 string, keys []string, args ...interface{}) (res *redis.Cmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.EvalShaRO(ctx, sha1, r.ks(keys...), args...)
	case ClientNormal:
		res = r.client.EvalShaRO(ctx, sha1, r.ks(keys...), args...)
	}
	return res
}
...
func (r *Client) SPublish(ctx context.Context, channel string, message interface{}) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.SPublish(ctx, r.k(channel), message)
	case ClientNormal:
		res = r.client.SPublish(ctx, r.k(channel), message)
	}
	return res
}
...
func (r *Client) PubSubNumSub(ctx context.Context, channels ...string) (res *redis.MapStringIntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
...
func (r *Client) PubSubShardChannels(ctx context.Context, pattern string) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.PubSubShardChannels(ctx, r.k(pattern))
	case ClientNormal:
		res = r.client.PubSubShardChannels(ctx, r.k(pattern))
	}
	return res
}

func (r *Client) PubSubShardNumSub(ctx context.Context, channels ...string) (res *redis.MapStringIntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.PubSubShardNumSub(ctx, r.ks(channels...)...)
	case ClientNormal:
		res = r.client.PubSubShardNumSub(ctx, r.ks(channels...)...)
	}
	return res
}
...
func (r *Client) GeoSearch(ctx context.Context, key string, q *redis.GeoSearchQuery) (res *redis.StringSliceCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.GeoSearch(ctx, r.k(key), q)
	case ClientNormal:
		res = r.client.GeoSearch(ctx, r.k(key), q)
	}
	return res
}
func (r *Client) GeoSearchLocation(ctx context.Context, key string, q *redis.GeoSearchLocationQuery) (res *redis.GeoSearchLocationCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.GeoSearchLocation(ctx, r.k(key), q)
	case ClientNormal:
		res = r.client.GeoSearchLocation(ctx, r.k(key), q)
	}
	return res
}
func (r *Client) GeoSearchStore(ctx context.Context, key, store string, q *redis.GeoSearchStoreQuery) (res *redis.IntCmd) {
	if ctx == nil || ctx.Err() != nil {
		ctx = context.TODO()
	}
	switch r.clientType {
	case ClientCluster:
		res = r.clusterClient.GeoSearchStore(ctx, r.k(key), store, q)
	case ClientNormal:
		res = r.client.GeoSearchStore(ctx, r.k(key), store, q)
	}
	return res
}
