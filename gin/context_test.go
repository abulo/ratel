...
import (
	...
	testdata "github.com/abulo/ratel/v3/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/abulo/ratel/v3/gin.handlerNameTest$", c.HandlerName())
}
...
func TestRaceParamsContextCopy(t *testing.T) {
	...
	wg.Add(2)
	{
		nameGroup.GET("/api", util.Uniqid(""), func(c *Context) {
