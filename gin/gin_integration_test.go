...
func TestRunEmpty(t *testing.T) {
	...
	router := New()
	go func() {
		router.GET("/example", "TestRunEmpty", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestRunTLS(t *testing.T) {
	router := New()
	go func() {
		router.GET("/example", "TestRunTLS", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
`))
	...
	go func() {
		router.GET("/pusher", "pusher", func(c *Context) {
...
func TestRunEmptyWithEnv(t *testing.T) {
	...
	router := New()
	go func() {
		router.GET("/example", "TestRunEmptyWithEnv", func(c *Context) { c.String(http.StatusOK, "it worked") })
		assert.NoError(t, router.Run())
	}()
	// have to wait for the goroutine to start and run the server
	// otherwise the main thread will complete
...
func TestRunWithPort(t *testing.T) {
	router := New()
	go func() {
		router.GET("/example", "TestRunWithPort", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestUnixSocket(t *testing.T) {
	...
	go func() {
		router.GET("/example", "TestUnixSocket", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestFileDescriptor(t *testing.T) {
	...
	go func() {
		router.GET("/example", "TestFileDescriptor", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestListener(t *testing.T) {
	...
	assert.NoError(t, err)
	go func() {
		router.GET("/example", "TestListener", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestWithHttptestWithAutoSelectedPort(t *testing.T) {
	router := New()
	router.GET("/example", "TestWithHttptestWithAutoSelectedPort", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestConcurrentHandleContext(t *testing.T) {
	router := New()
	router.GET("/", "TestConcurrentHandleContext", func(c *Context) {
		c.Request.URL.Path = "/example"
		router.HandleContext(c)
	})
	router.GET("/example", "TestConcurrentHandleContext1", func(c *Context) { c.String(http.StatusOK, "it worked") })
...
func TestTreeRunDynamicRouting(t *testing.T) {
	router := New()
	router.GET("/aa/*xx", "TestTreeRunDynamicRouting", func(c *Context) { c.String(http.StatusOK, "/aa/*xx") })
