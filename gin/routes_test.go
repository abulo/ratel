...
func testRouteOK(method string, t *testing.T) {
	...
	passedAny := false
	r := New()
	r.Any("/test2", util.Uniqid(""), func(c *Context) {
		passedAny = true
	})
	r.Handle(method, "/test", util.Uniqid(""), func(c *Context) {
		passed = true
	})
...
func testRouteNotOK(method string, t *testing.T) {
	passed := false
	router := New()
	router.Handle(method, "/test_2", util.Uniqid(""), func(c *Context) {
		passed = true
	})
...
func testRouteNotOK2(method string, t *testing.T) {
	...
	router.Handle(methodRoute, "/test", util.Uniqid(""), func(c *Context) {
		passed = true
	})
...
func TestRouterMethod(t *testing.T) {
	router := New()
	router.PUT("/hey2", util.Uniqid(""), func(c *Context) {
		c.String(http.StatusOK, "sup2")
	})

	router.PUT("/hey", util.Uniqid(""), func(c *Context) {
		c.String(http.StatusOK, "called")
	})

	router.PUT("/hey3", util.Uniqid(""), func(c *Context) {
...
func TestRouteRedirectTrailingSlash(t *testing.T) {
	...
	router.GET("/path", util.Uniqid(""), func(c *Context) {})
	router.GET("/path2/", util.Uniqid(""), func(c *Context) {})
	router.POST("/path3", util.Uniqid(""), func(c *Context) {})
	router.PUT("/path4/", util.Uniqid(""), func(c *Context) {})
...
func TestRouteRedirectFixedPath(t *testing.T) {
	...
	router.GET("/Path2", util.Uniqid(""), func(c *Context) {})
	router.POST("/PATH3", util.Uniqid(""), func(c *Context) {})
	router.POST("/Path4/", util.Uniqid(""), func(c *Context) {})
...
func TestRouteParamsByName(t *testing.T) {
	...
	wild := ""
	router := New()
	router.GET("/test/:name/:last_name/*wild", util.Uniqid(""), func(c *Context) {
...
func TestRouteNotAllowedEnabled(t *testing.T) {
	router := New()
	router.HandleMethodNotAllowed = true
	router.POST("/path", util.Uniqid(""), func(c *Context) {})
	w := PerformRequest(router, http.MethodGet, "/path")
	assert.Equal(t, http.StatusMethodNotAllowed, w.Code)
...
func TestRouteNotAllowedEnabled2(t *testing.T) {
	...
	router.addRoute(http.MethodPost, "/", util.Uniqid(""), HandlersChain{func(_ *Context) {}})
	router.GET("/path2", util.Uniqid(""), func(c *Context) {})
...
func TestRouterNotFound(t *testing.T) {
	...
	router.RedirectFixedPath = true
	router.GET("/path", util.Uniqid(""), func(c *Context) {})
	router.GET("/dir/", util.Uniqid(""), func(c *Context) {})
	router.GET("/", util.Uniqid(""), func(c *Context) {})
	...
	router.PATCH("/path", util.Uniqid(""), func(c *Context) {})
	...
	router = New()
	router.GET("/a", util.Uniqid(""), func(c *Context) {})
	w = PerformRequest(router, http.MethodGet, "/")
	assert.Equal(t, http.StatusNotFound, w.Code)
	...
	router.GET("/logout", util.Uniqid(""), func(c *Context) {
		c.String(200, "logout")
	})
...
func TestRouteRawPath(t *testing.T) {
	...
	route.POST("/project/:name/build/:num", util.Uniqid(""), func(c *Context) {
		name := c.Params.ByName("name")
...
func TestRouteContextHoldsFullPath(t *testing.T) {
	...
	for _, route := range routes {
		actualRoute := route
		router.GET(route, util.Uniqid(""), func(c *Context) {
