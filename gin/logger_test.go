...
func TestLogger(t *testing.T) {
	...
	router.GET("/example", util.Uniqid(""), func(c *Context) {})
	router.POST("/example", util.Uniqid(""), func(c *Context) {})
	router.PUT("/example", util.Uniqid(""), func(c *Context) {})
	router.DELETE("/example", util.Uniqid(""), func(c *Context) {})
	router.PATCH("/example", util.Uniqid(""), func(c *Context) {})
	router.HEAD("/example", util.Uniqid(""), func(c *Context) {})
	router.OPTIONS("/example", util.Uniqid(""), func(c *Context) {})
...
func TestLoggerWithWriterSkippingPaths(t *testing.T) {
	...
	router.GET("/logged", util.Uniqid(""), func(c *Context) {})
	router.GET("/skipped", util.Uniqid(""), func(c *Context) {})
