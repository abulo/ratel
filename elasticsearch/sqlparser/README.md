# sqlparser [![Build Status](https://img.shields.io/travis/xwb1989/sqlparser.svg)](https://travis-ci.org/xwb1989/sqlparser) [![Coverage](https://img.shields.io/coveralls/xwb1989/sqlparser.svg)](https://coveralls.io/github/xwb1989/sqlparser) [![Report card](https://goreportcard.com/badge/github.com/abulo/ratel/elasticsearch/sqlparser)](https://goreportcard.com/report/github.com/abulo/ratel/elasticsearch/sqlparser) [![GoDoc](https://godoc.org/github.com/abulo/ratel/elasticsearch/sqlparser?status.svg)](https://godoc.org/github.com/abulo/ratel/elasticsearch/sqlparser)
...
See [parse_test.go](https://github.com/abulo/ratel/elasticsearch/sqlparser/blob/master/parse_test.go) for more examples, or read the [godoc](https://godoc.org/github.com/abulo/ratel/elasticsearch/sqlparser).
...
XWB1989=${GOPATH?}/src/github.com/abulo/ratel/elasticsearch/sqlparser/
...
# Fix imports
sed -i '.bak' 's_vitess.io/vitess/go/vt/proto/query_github.com/abulo/ratel/elasticsearch/sqlparser/dependency/querypb_g' *.go dependency/sqltypes/*.go
sed -i '.bak' 's_vitess.io/vitess/go/_github.com/abulo/ratel/elasticsearch/sqlparser/dependency/_g' *.go dependency/sqltypes/*.go
